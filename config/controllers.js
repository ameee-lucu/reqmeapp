...
module.exports.controllers = {
   ...
   * a model exists with the same name as the controllers, Sails will respond with built-in CRUD
  ...
  */
  blueprints: {
     ...
     * When enabled, GET, POST, PUT, and DELETE routes will be generated for every one of a controllers's actions.
     *
     ...
     * you must take great care not to inadvertently expose unsafe controllers logic to GET requests.
     */
    actions: true,
     ...
     * a conventional REST API on top of a controllers's `find`, `create`, `update`, and `destroy`
     * actions.
     *
     ...
     * `shortcuts`
     *
     * Shortcut blueprints are simple helpers to provide access to a controllers's CRUD methods
     * from your browser's URL bar.  When enabled, GET, POST, PUT, and DELETE routes will be generated
     * for the controllers's`find`, `create`, `update`, and `destroy` actions.
     *
     ...
     * `prefix`
     *
     * An optional mount path for all blueprint routes on a controllers, including `rest`,
     ...
     * `pluralize`
     *
     * Whether to pluralize controllers names in generated routes
     *
