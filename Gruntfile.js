...
module.exports = function (grunt) {
  ...
  var jsFilesToInject = [
    ...
    //'linker/**/*.js',
      ...
      '/linker/bower_components/bootstrap/dist/js/bootstrap.js',
      ...
      '/linker/bower_components/firebase/firebase.js',
      '/linker/bower_components/angular-mocks/angular-mocks.js',
      '/linker/bower_components/firebase-simple-login/firebase-simple-login.js',
      '/linker/bower_components/angularfire/angularfire.js',
      '/linker/bower_components/angular-file-upload/angular-file-upload.js',
      '/linker/bower_components/angular-local-storage/angular-local-storage.js',
      '/linker/bower_components/angular-bootstrap/ui-bootstrap.js',
      '/linker/bower_components/angular-bootstrap/ui-bootstrap-tpls.js',
      '/linker/angular/app.js',
      '/linker/angular/angularfire/config.js',
      '/linker/angular/services/firebase.js',
      '/linker/angular/services/login.js',
      '/linker/angular/angularfire/simpleLoginTools.js',
      '/linker/angular/controllers/main.js',
      '/linker/angular/**/*.js'
  ];
